...
/**
 * ProductCard Component — Black & Red Luxury Aesthetic:
 * Deep Black #080808 image container, Warm White #F5F2EE name & price, Muted Gray #B8B3AF metadata.
...
export default function ProductCard({ product, className = '' }) {
  ...
  return (
    ...
    >
      {/* Compact Near-Black Image Container */}
      <div className="relative w-full overflow-hidden rounded-xl sm:rounded-2xl bg-[#080808] border border-white/10 aspect-[4/3.8] md:aspect-[4/4.5] shadow-sm group-hover:shadow-[0_8px_24px_rgba(0,0,0,0.6)] transition-all duration-300 group-hover:border-white/20">
