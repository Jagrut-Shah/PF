...
/**
 * ProductCard Component — Near-Black #0D0A0C bottle backdrop for high-contrast product bottle presentation,
 * Bodoni Moda 400 for Fragrance Names (Section 12), Manrope 600 for Prices (Section 14).
 */
export default function ProductCard({ product, className = '' }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full overflow-hidden rounded-xl sm:rounded-2xl bg-[#0D0A0C] border border-[#E7C4C5]/15 aspect-[4/3.8] md:aspect-[4/4.5] shadow-sm group-hover:shadow-[0_8px_24px_rgba(0,0,0,0.4)] transition-shadow duration-300">
