...
export default function ScentCategoryCard({ category }) {
  ...
  return (
    <Link
      to={category.link}
      className="group relative block w-full h-[235px] sm:h-[245px] md:h-[250px] rounded-xl sm:rounded-2xl overflow-hidden bg-[#151515] focus:outline-none focus-visible:ring-1 focus-visible:ring-elava-gold"
