 ...
 * Black & Red Luxury Aesthetic: Deep Black #0B0B0B environment with scroll reveal and button micro-interactions.
 */
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-7 lg:col-span-8 space-y-3">
              ...
              <div className="pt-3 flex flex-wrap items-center gap-3">
                <RouterLink
                  to="/discovery-set"
                  className="inline-flex items-center gap-2 bg-[#B4171E] hover:bg-[#C72A35] text-[#F5F2EE] px-5 py-2.5 rounded-lg font-sans text-xs font-bold uppercase tracking-[0.14em] transition-all duration-200 shadow-xs btn-interactive"
                >
