 ...
 * Section: Cherry #8B1E2D, Container: Rich Warm Sand Cream #DAC29F.
 */
  ...
  return (
    <section className="py-7 sm:py-9 bg-[#8B1E2D] text-[#DAC29F]">
      <MainContainer>
        <div
          ref={ref}
          className={`bg-[#DAC29F] border border-[#BD9F7B] rounded-2xl p-5 sm:p-7 md:p-8 shadow-md text-[#2A211F] relative overflow-hidden reveal-init ${
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-5 lg:col-span-4">
              <div className="relative aspect-[16/10] sm:aspect-[4/3] rounded-xl overflow-hidden border border-[#BD9F7B] bg-[#D0B48F] shadow-xs group">
                <img
            ...
            <div className="md:col-span-7 lg:col-span-8 space-y-3">
              ...
              <p className="font-manrope text-[14px] text-[#594B40] leading-[1.6]">
                Experience our handcrafted 60 ML Eau de Parfum collection before choosing your full-size signature bottle.
              </p>

              {/* What You Receive */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1 text-[13px] font-manrope text-[#594B40]">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3">
                <RouterLink
                  to="/discovery-set"
                  className="inline-flex items-center gap-2 bg-[#8B1E2D] hover:bg-[#64141F] text-[#DAC29F] px-5 py-2.5 rounded-lg font-manrope text-[13px] font-semibold tracking-[0.01em] transition-all duration-200 shadow-xs btn-interactive"
                >
