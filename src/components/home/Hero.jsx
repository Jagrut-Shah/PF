...
/**
 * Hero Component for ÉLAVA — Cormorant Garamond Editorial Display + Manrope UI
 */
    ...
    <section className="relative w-full bg-[#2A0D14] text-[#F6EFE7] overflow-hidden border-b border-[#E7C4C5]/15">
      ...
      <MainContainer className="relative z-10 py-14 sm:py-20 md:py-28 lg:py-32">
        <div className="max-w-2xl">
          {/* Section Label / Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#641D2D] border border-[#E7C4C5]/20 mb-6 text-[11px] font-sans font-semibold tracking-[0.18em] uppercase text-[#E7C4C5]">
            <Sparkles className="w-3.5 h-3.5 text-[#E7C4C5]" />
            <span>60 ml Eau de Parfum Collection</span>
          </div>

          {/* Editorial Display Headline */}
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal tracking-tight text-[#F6EFE7] leading-[1.05] mb-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link
              ...
              className="inline-flex items-center gap-2.5 bg-[#C94B5B] hover:bg-[#B03D4C] text-[#F6EFE7] px-7 py-3.5 rounded-xl font-sans text-xs sm:text-sm font-semibold tracking-wider transition-all duration-200 shadow-md hover:shadow-lg focus:outline-none"
            >
            ...
            <Link
              to="/category/unisex"
              className="inline-flex items-center gap-2 bg-[#641D2D] hover:bg-[#7A2437] text-[#F6EFE7] border border-[#E7C4C5]/20 px-6 py-3.5 rounded-xl font-sans text-xs sm:text-sm font-semibold tracking-wider transition-colors duration-200"
            >
