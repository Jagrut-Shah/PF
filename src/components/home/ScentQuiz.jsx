              ...
              {currentStep > 0 && (
                <div className="mt-6 pt-4 border-t border-white/10 flex justify-between items-center">
                  <button
                    ...
                    className="text-xs font-sans font-medium text-[#B8B3AF] hover:text-[#F5F2EE] transition-colors"
                  >
                    ← Back
                  </button>
                  <button
                    type="button"
                    onClick={handleReset}
                    className="text-xs font-sans text-[#B8B3AF]/60 hover:text-[#B8B3AF] transition-colors flex items-center gap-1"
                  >
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-white/10 pb-4">
                ...
                <button
                  type="button"
                  onClick={handleReset}
                  className="text-xs font-sans text-[#B8B3AF] hover:text-[#F5F2EE] flex items-center gap-1 border border-white/10 px-3 py-1.5 rounded-lg bg-[#080808]"
                >
                  <RotateCcw className="w-3 h-3" />
                  <span>Retake</span>
                </button>
              ...
              {/* Primary Match */}
              {displayProducts[0] && (
                <div className="bg-[#080808] border border-white/15 rounded-xl p-4 flex flex-col sm:flex-row items-center gap-4">
                  <img
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {displayProducts.slice(1, 3).map((p) => (
                      <Link
                        key={p.id}
                        to={`/product/${p.slug}`}
                        className="group bg-[#080808]/70 border border-white/10 rounded-lg p-3 flex items-center justify-between hover:border-[#B4171E]/40 active:scale-[0.98] transition-all"
                      >
