...
/**
 * ÉLAVA Footer
 * Dark Teal Canvas (#123C3A) with rgba(245,241,234,0.12) dividers.
 * Primary Text: #F5F1EA
 * Secondary Text: #B8C3C1
 * WhatsApp: #25D366
 */
...
// Instagram SVG icon
const InstagramIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="#E4405F" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5 shrink-0 text-[#E4405F] stroke-[#E4405F]" aria-hidden="true">
...
const linkCls = 'block font-sans text-[12px] text-[#B8C3C1] hover:text-[#F5F1EA] transition-colors duration-150 leading-none py-1';
const connectLinkCls = 'inline-flex items-center gap-1.5 font-sans text-[12px] text-[#B8C3C1] hover:text-[#F5F1EA] transition-colors duration-150 leading-none py-1';
const headingCls = 'font-sans text-[9.5px] font-semibold tracking-[0.22em] uppercase text-[#F5F1EA] mb-3.5';

// ── Mobile accordion ──────────────────────────────────────────────────────
function Accordion({ title, children }) {
  const [open, setOpen] = useState(false);
  return (
    <div className="border-b border-[rgba(245,241,234,0.12)]">
      <button
        type="button"
        onClick={() => setOpen(o => !o)}
        aria-expanded={open}
        className="w-full flex items-center justify-between py-3 focus:outline-none focus-visible:ring-1 focus-visible:ring-[#F5F1EA]"
      >
        <span className={headingCls.replace('mb-3.5', '')}>{title}</span>
        {open
          ? <Minus size={13} className="text-[#B8C3C1] shrink-0" aria-hidden="true" />
          : <Plus  size={13} className="text-[#B8C3C1] shrink-0" aria-hidden="true" />}
      </button>
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0F4C5C] border-t border-[rgba(245,241,234,0.12)]" aria-label="Site footer">
          ...
          <div className="py-8 grid grid-cols-[2fr_1fr_1fr_1fr] gap-8">
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="font-sans text-[11.5px] text-[#B8C3C1] leading-snug">
        ...
        <div className="border-t border-[rgba(245,241,234,0.12)]">
          <MainContainer>
            <div className="py-4 flex items-center justify-between">
              <p className="font-sans text-[10.5px] text-[#B8C3C1]">© {year} ÉLAVA Perfumes. All rights reserved.</p>
              <div className="flex items-center gap-4">
                <Link to="/privacy" className="font-sans text-[10.5px] text-[#B8C3C1] hover:text-[#F5F1EA] transition-colors duration-150">Privacy Policy</Link>
                <Link to="/terms"   className="font-sans text-[10.5px] text-[#B8C3C1] hover:text-[#F5F1EA] transition-colors duration-150">Terms & Conditions</Link>
              </div>
            </div>
          </MainContainer>
        </div>
      ...
      <div className="md:hidden">
        ...
        {/* Legal */}
        <div className="border-t border-[rgba(245,241,234,0.12)] mt-1">
          <MainContainer>
            <div className="py-3.5 flex flex-wrap items-center gap-x-3 gap-y-1">
              <p className="font-sans text-[10.5px] text-[#B8C3C1]">© {year} ÉLAVA Perfumes.</p>
              <Link to="/privacy" className="font-sans text-[10.5px] text-[#B8C3C1] hover:text-[#F5F1EA] transition-colors duration-150">Privacy Policy</Link>
              <span className="text-[#B8C3C1]/40 text-[10px]">·</span>
              <Link to="/terms"   className="font-sans text-[10.5px] text-[#B8C3C1] hover:text-[#F5F1EA] transition-colors duration-150">Terms & Conditions</Link>
            </div>
          </MainContainer>
        </div>
