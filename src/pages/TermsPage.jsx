  ...
  return (
    <div className="w-full bg-[#0B0B0B] text-[#F5F2EE] min-h-screen">
      ...
      <MainContainer className="py-8 sm:py-10 md:py-14">
        ...
        <div className="max-w-3xl mx-auto mb-8 p-4 bg-[#121212] border border-white/10 rounded-xl text-center shadow-sm">
          <p className="font-manrope text-[13px] font-semibold uppercase tracking-[0.09em] text-[#F5F2EE]">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-[#121212] border border-white/10 rounded-xl p-6 shadow-sm">
            ...
            <p className="font-manrope text-[15px] text-[#F5F2EE] font-semibold">
              Customer Support: <a href={`mailto:${DEMO_COMPANY_INFO.supportEmail}`} className="underline hover:text-[#B4171E]">{DEMO_COMPANY_INFO.supportEmail}</a> <span className="text-xs text-[#B8B3AF] font-normal">(DEMO)</span>
            </p>
          </div>
