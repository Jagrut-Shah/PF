        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-[#0D3B48] border border-[rgba(245,241,234,0.15)] rounded-xl p-6 shadow-sm">
            ...
            <p className="font-sans text-xs sm:text-sm text-[#F5F1EA] font-semibold">
              Customer Support: <a href={`mailto:${DEMO_COMPANY_INFO.supportEmail}`} className="underline hover:text-white">{DEMO_COMPANY_INFO.supportEmail}</a> <span className="text-xs text-[#B8C4C2] font-normal">(DEMO)</span>
            </p>
          </div>
