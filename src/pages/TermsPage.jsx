        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-[#FAF7F2] border border-[#ECE7DE] rounded-xl p-6">
            ...
            <p className="font-sans text-xs sm:text-sm text-[#171717] font-semibold">
              Customer Support: <a href={`mailto:${DEMO_COMPANY_INFO.supportEmail}`} className="underline hover:text-[#CFA838]">{DEMO_COMPANY_INFO.supportEmail}</a> <span className="text-xs text-[#77736B] font-normal">(DEMO)</span>
            </p>
          </div>
