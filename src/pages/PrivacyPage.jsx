        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-[#121212] border border-white/10 rounded-xl p-6 shadow-sm">
            ...
            <p className="font-manrope text-[15px] text-[#F5F2EE] font-semibold">
              Privacy Email: <a href={`mailto:${DEMO_COMPANY_INFO.privacyEmail}`} className="underline hover:text-[#B4171E]">{DEMO_COMPANY_INFO.privacyEmail}</a> <span className="text-xs text-[#B8B3AF] font-normal">(DEMO)</span>
            </p>
          </div>
