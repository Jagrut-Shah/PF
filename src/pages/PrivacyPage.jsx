    ...
    <div className="w-full bg-[#2A0D14] text-[#F6EFE7] min-h-screen">
      ...
      <MainContainer className="py-8 sm:py-10 md:py-14">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-[#1C4A55] border border-[rgba(243,235,221,0.15)] rounded-xl p-6 shadow-sm">
            <h2 className="font-sans text-xs font-bold uppercase tracking-[0.2em] text-[#F3EBDD] mb-3">
              1. INFORMATION WE COLLECT
            </h2>
            <p className="font-sans text-xs sm:text-sm text-[#C8C1B5] leading-relaxed mb-3">
            ...
            <ul className="list-disc list-inside space-y-1.5 font-sans text-xs sm:text-sm text-[#C8C1B5]">
          ...
          <div className="bg-[#1C4A55] border border-[rgba(243,235,221,0.15)] rounded-xl p-6 shadow-sm">
            ...
            <p className="font-sans text-xs sm:text-sm text-[#F3EBDD] font-semibold">
              Privacy Email: <a href={`mailto:${DEMO_COMPANY_INFO.privacyEmail}`} className="underline hover:text-[#C5A15A]">{DEMO_COMPANY_INFO.privacyEmail}</a> <span className="text-xs text-[#C8C1B5] font-normal">(DEMO)</span>
            </p>
          </div>
